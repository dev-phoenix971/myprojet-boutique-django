...
def register(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            first_name = form.cleaned_data_(['first_name'])
            last_name = form.cleaned_data_(['last_name'])
            phone_number = form.cleaned_data_(['phone_number'])
            email = form.cleaned_data_(['email'])
            password = form.cleaned_data_(['password'])
            ...
            profile.profile_picture = 'default/profilepic.jpg'
            profile.save()
...
@login_required(login_url = '_(login)')
...
def resetPassword(request):
    if request.method == 'POST':
        ...
        confirm_password = request.POST['_(confirm_password)']
